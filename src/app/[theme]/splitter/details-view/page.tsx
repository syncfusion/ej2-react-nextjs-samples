...
const DetailsView = () => {
    ...
    commonData = [
        { name: 'Margaret', imgUrl: '/nextjs/demos/images/splitter/margaret.png', id: '1' },
        { name: 'Laura', imgUrl: '/nextjs/demos/images/splitter/laura.png', id: '2' },
        { name: 'Robert', imgUrl: '/nextjs/demos/images/splitter/robert.png', id: '3' },
        { name: 'Albert', imgUrl: '/nextjs/demos/images/splitter/albert.png', id: '5' },
        { name: 'Michale', imgUrl: '/nextjs/demos/images/splitter/michale.png', id: '4' }
    ];
