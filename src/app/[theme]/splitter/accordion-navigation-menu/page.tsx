...
const AccordionIntegration = () => {
  ...
  const onSelect = (e: SelectEventArgs): void => {
    ...
    switch (listid) {
      case "1":
        let ajax: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnet-grid-ajax.html", "GET", true);
        ajax.send().then();
        ...
        break;
      case "2":
        let ajax1: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnet-schedule-ajax.html", "GET", true);
        ajax1.send().then();
        ...
        break;
      case "3":
        let ajax2: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnetmvc-grid-ajax.html", "GET", true);
        ajax2.send().then();
        ...
        break;
      case "4":
        let ajax3: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnetmvc-schedule-ajax.html", "GET", true);
        ajax3.send().then();
      ...
      case "5":
        let ajax4: Ajax = new Ajax(
          "/nextjs/demos/images/splitter/javascript-grid-ajax.html",
          "GET",
          true
        );
        ajax4.send().then();
        ...
        break;
      case "6":
        let ajax5: Ajax = new Ajax("/nextjs/demos/images/splitter/javascript-schedule-ajax.html", "GET", true);
        ajax5.send().then();
        ...
        break;
      case "7":
        let ajax6: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnet-chart-ajax.html", "GET", true);
        ajax6.send().then();
        ...
        break;
      case "8":
        let ajax7: Ajax = new Ajax("/nextjs/demos/images/splitter/aspnetmvc-chart-ajax.html", "GET", true);
        ajax7.send().then();
        ...
        break;
      case "9":
        let ajax8: Ajax = new Ajax("/nextjs/demos/images/splitter/javascript-chart-ajax.html", "GET", true);
        ajax8.send().then();
