...
import bridge from "@/images/image-editor/bridge.jpg"
...
const CustomToolbar = () => {
    ...
    const onIECreated = () => {
        ...
        if (Browser.isDevice && image) {
            image.src = '/nextjs/demos/images/image-editor/flower.png';
        }
                    ...
                    <div className='col-lg-12 control-section e-img-editor-sample'>
                        ...
                        <div className="header">
                            ...
                            <div className='image-preview-container' id='imagePreviewContainer'>
                                <Image src={bridge} id="previewImgContainer" className="preview-img-container" alt="previewImage" />
                                <br />
