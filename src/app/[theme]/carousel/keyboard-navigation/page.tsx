        ...
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="100%" height="100%" src="/nextjs/demos/images/carousel/san-francisco.jpg" alt="San Francisco" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate2 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="100%" height="100%" src="/nextjs/demos/images/carousel/london.jpg" alt="London" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate3 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="100%" height="100%" src="/nextjs/demos/images/carousel/tokyo.jpg" alt="Tokyo" />
                    </picture>
                </div>
            </div>
        );
    ...
    const itemTemplate4 = () => {
        return (
            <div className="product-container">
                ...
                <div className="col-sm-5 image-container">
                    <picture>
                        <img width="100%" height="100%" src="/nextjs/demos/images/carousel/moscow.jpg" alt="Moscow" />
                    </picture>
                </div>
            </div>
        );
