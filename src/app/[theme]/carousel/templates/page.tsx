...
import cardinal from "@/images/carousel/cardinal.png"
import hunei from "@/images/carousel/hunei.png"
import costarica from "@/images/carousel/costa-rica.png"
import kaohsiung from "@/images/carousel/kaohsiung.png"
import beeeater from "@/images/carousel/bee-eater.png"
...
const Templates = () => {
    ...
    const itemTemplate1 = () => {
        return (
            <figure className="img-container">
                <Image src={cardinal} alt="cardinal" style={{ height: "100%", width: "100%" }} />
            </figure>
        );
    }
    ...
    const itemTemplate2 = () => {
        return (
            <figure className="img-container">
                <Image src={hunei} alt="hunei" style={{ height: "100%", width: "100%" }} />
            </figure>
        );
    }
    ...
    const itemTemplate3 = () => {
        return (
            <figure className="img-container">
                <Image src={costarica} alt="costa-rica" style={{ height: "100%", width: "100%" }} />
            </figure>
        );
    }
    ...
    const itemTemplate4 = () => {
        return (
            <figure className="img-container">
                <Image src={kaohsiung} alt="kaohsiung" style={{ height: "100%", width: "100%" }} />
            </figure>
        );
    }
    ...
    const itemTemplate5 = () => {
        return (
            <figure className="img-container">
                <Image src={beeeater} alt="bee-eater" style={{ height: "100%", width: "100%" }} />
            </figure>
        );
    }
    ...
    const indicatorTemplate = (props: any) => {
        ...
        return (
            <div className="indicator">
                <img src={`/nextjs/demos/images/carousel/${birds[props.index]}.png`} alt="image" style={{ height: "100%", width: "100%" }} />
            </div>
        );
    }
