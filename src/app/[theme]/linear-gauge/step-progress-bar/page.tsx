                ...
                <LinearGaugeComponent load={load} axisLabelRender={axisLabelRender} id='gauge' background='transparent' orientation='Horizontal'>
                    <AxesDirective>
                        <AxisDirective minimum={5} maximum={20} opposedPosition={true} majorTicks={{ height: 0, interval: 5 }} minorTicks={{ height: 0 }} line={{ width: 5 }} labelStyle={{ offset: 20, font: { size: '16px', fontFamily: 'inherit' } }}>
                            <PointersDirective>
                                <PointerDirective value={5} height={25} width={25} placement='Near' markerType='Image' imageUrl='/nextjs/demos/images/linear-gauge/tick-icon.png' />
                                <PointerDirective value={10} height={25} width={25} placement='Near' markerType='Image' imageUrl='/nextjs/demos/images/linear-gauge/tick-icon.png' />
                                <PointerDirective value={15} height={25} width={25} placement='Near' markerType='Image' imageUrl='/nextjs/demos/images/linear-gauge/tick-icon.png' />
