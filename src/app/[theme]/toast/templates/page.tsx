...
function Templates (){
    ...
    const toastData: { [key: string]: Object }[] = [
        { from: ' Anjolie Stokes', subject: 'Networking Referral', image: { url: '/nextjs/demos/images/toast/laura.png' }, },
        { from: ' Ila Russo', subject: 'Business dinner invitation', image: { url: '/nextjs/demos/images/toast/janat.png' }, },
        { from: ' Camden Mcmillan', subject: 'Reference Request - Cameran Hester', image: { url: '/nextjs/demos/images/toast/camden.png' }, },
        { from: ' Chase Solomon', subject: 'New business relationship confirmation', image: { url: '/nextjs/demos/images/toast/chase.png' }, },
        {
            from: ' Inga Scott', subject: 'Application for Sales Associate', image: { url: '/nextjs/demos/images/toast/michael.png' },
        }];
        ...
        return (
            <div id="template_toast_ele">
                <div id='template_toast'>
                    ...
                    <img src="/nextjs/demos/images/toast/map.jpg" width="100%" height="70%" />
