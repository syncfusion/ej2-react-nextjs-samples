...
function Print() {
    ...
    const image: ImageModel[] = [{src:'/nextjs/demos/images/spreadsheet/luxury-car.png', height: 40, width: 80, top: 5, left: 130}];
    const yearlyReportImage: ImageModel[] = [{src:'/nextjs/demos/images/spreadsheet/luxury-car.png', height: 40, width: 80, top: 5, left: 95}];
                    ...
                    <SheetsDirective>
                        <SheetDirective name='Car Sales'>
                            ...
                            <RowsDirective>
                                <RowDirective height={30}>
                                    <CellsDirective>
                                        <CellDirective image={image} ></CellDirective>
                        ...
                        <SheetDirective name='Yearly Report'>
                            ...
                            <RowsDirective>
                                <RowDirective height={30}>
                                    <CellsDirective>
                                        <CellDirective image={yearlyReportImage} ></CellDirective>
