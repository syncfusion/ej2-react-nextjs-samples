...
import okalahomaMap from './okalahoma.json';
import Image from 'next/image';
import atm from "@/images/maps/atm.png"
const SAMPLE_CSS = `
    .control-fluid {
        ...
        <div className='control-panel'>
            ...
            <div className='control-section row'>
                <div style={{ width: 350, margin: 'auto', paddingBottom: 20 }}>
                    <Image src={atm} alt="ATM indication" style={{ width: 25, height: 25, float: 'left' }} />
                    ...
                    <MapsComponent id="maps" loaded={onMapsLoad} load={load} zoomSettings={{ enable: false, zoomFactor: 2 }} centerPosition={{ latitude: 35.65, longitude: -97.3 }}>
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={okalahomaMap} shapeSettings={{ fill: '#F5F5F5', border: { color: '#EEDA97', width: 1 } }}>
                                <MarkersDirective>
                                    <MarkerDirective visible={true} width={20} height={20} shape='Image' imageUrl='/nextjs/demos/images/maps/ballon.png' fill='#000080' border={{ color: 'transparent' }} dataSource={marker2} tooltipSettings={{ visible: true, valuePath: 'title' }} />
