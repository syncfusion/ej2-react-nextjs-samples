...
import data from './marker-cluster.json';
        ...
        <div className='control-panel'>
            ...
            <div className='control-section'>
                <MapsComponent id="maps" load={load} useGroupingSeparator={true} format='n' zoomSettings={{ enable: true }} titleSettings={{ text: 'Top 50 largest cities in the World', textStyle: { size: '16px' } }}>
                    ...
                    <LayersDirective>
                        <LayerDirective shapeData={worldMap} shapeSettings={{ fill: '#C1DFF5' }} markerClusterSettings={{ allowClustering: true, shape: 'Image', height: 40, width: 40, labelStyle: { color: 'white' }, imageUrl: '/nextjs/demos/images/maps/cluster.svg' }}>
                            <MarkersDirective>
                                <MarkerDirective visible={true} dataSource={datasource.cluster} shape='Image' imageUrl='/nextjs/demos/images/maps/ballon.png' tooltipSettings={{ visible: true, valuePath: 'area', template: template }} height={20} width={20} animationDuration={0} />
                            </MarkersDirective>
                        </LayerDirective>
                    </LayersDirective>
                </MapsComponent>
