...
import seatSelection from './seat-selection.json';
import Image from 'next/image';
import busIcon from "@/images/maps/bus-icon.png"
import wheel from "@/images/maps/wheel.png"
const SAMPLE_CSS = `
    #control-container {
            ...
            <div className='control-section row'>
                <div className='col-md-8'>
                    <div style={{ width: 200, margin: 'auto', paddingBottom: 20 }}>
                        <Image src={busIcon} alt="Bus icon" style={{ width: 25, height: 25, float: 'left' }} />
                        <div id="sampletitle">Bus seat selection</div>
                    </div>
                    <div style={{ border: '3px solid darkgray', width: 200, display: 'block', margin: 'auto' }}>
                        <Image src={wheel} alt="Stering wheel icon" style={{ width: 30, height: 30, marginLeft: '18%', marginTop: 10 }} />
