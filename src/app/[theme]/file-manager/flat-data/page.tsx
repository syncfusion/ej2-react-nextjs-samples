    ...
    return (
        <div>
            ...
            <div id="action-description">
                <p>This sample demonstrates the flat data rendering of the File Manager component. The File Manager uses a flat data object as an array of JavaScript objects for rendering, eliminating the need to define ajaxSettings url.</p>
            </div>
            ...
            <div id="description">
                ...
                <p>To load a folder data as an array of JavaScript objects, use the File Manager component <code>fileSystemData</code> property.</p>
            </div>
        </div>
    );
}
