                                    ...
                                    <AxesDirective>
                                        <AxisDirective startAngle={230} endAngle={130} minimum={-100} maximum={100} lineStyle={{ width: 0, color: 'transparent' }} majorTicks={{ width: 0, height: 0 }} minorTicks={{ width: 0, height: 0 }} labelStyle={{ position: 'Outside', font: { size: '0', color: 'transparent' } }}>
                                            <AnnotationsDirective>
                                                <AnnotationDirective content='<div id="templateWrap"><img class="imageStyle" src="/nextjs/demos/images/circular-gauge/positive.png" alt="Positive value for Germany"/><div class="fontDes">${pointers[0].value}%</div></div></div>' angle={180} zIndex='1' radius='30%' />
                                ...
                                <CircularGaugeComponent load={load.bind(this)} style={{ height: "250px" }} background='transparent' ref={sampleGaugeTwo} id='sample2-container'>
                                    ...
                                    <AxesDirective>
                                        <AxisDirective startAngle={230} endAngle={130} minimum={-100} maximum={100} lineStyle={{ width: 0, color: 'transparent' }} majorTicks={{ width: 0, height: 0 }} minorTicks={{ width: 0, height: 0 }} labelStyle={{ position: 'Outside', font: { size: '0', color: 'transprent' } }}>
                                            <AnnotationsDirective>
                                                <AnnotationDirective content='<div id="templateWrap"><img class="imageStyle" src="/nextjs/demos/images/circular-gauge/positive.png" alt="Positive value for USA" /><div class="fontDes">${pointers[0].value}%</div></div></div>' angle={180} zIndex='1' radius='30%' />
                            ...
                            <div className="col-sm-4">
                                <CircularGaugeComponent load={load.bind(this)} style={{ height: "250px" }} background='transparent' ref={sampleGaugeThree} loaded={onChartLoad.bind(this)} id='sample3-container'>
                                    ...
                                    <AxesDirective>
                                        <AxisDirective startAngle={230} endAngle={130} minimum={-100} maximum={100} lineStyle={{ width: 0, color: 'transparent' }} majorTicks={{ width: 0, height: 0 }} minorTicks={{ width: 0, height: 0 }} labelStyle={{ position: 'Outside', font: { size: '0', color: 'transparent' } }}>
                                            <AnnotationsDirective>
                                                <AnnotationDirective content='<div id="templateWrap"><img class="imageStyle" src="/nextjs/demos/images/circular-gauge/negative.png" alt="Negative value for UK" /><div class="fontDes">${pointers[0].value}%</div></div></div>' angle={180} zIndex='1' radius='30%' />
