...
const AppleWatchGauge = () => {
    ...
    const loadRedGauge = (args: ILoadedEventArgs): void => {
        ...
        if (selectedTheme === 'highcontrast') {
            args.gauge.axes[0].annotations[0].content = '<div id="annotation5"><img style="width:17px;height:17px;margin-left:1px" src="/nextjs/demos/images/circular-gauge/image4.svg" /></div>';
        }
        // custom code end
    }
    ...
    const loadGreenGauge = (args: ILoadedEventArgs): void => {
        ...
        args.gauge.theme = ((selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1)).replace(/-dark/i, 'Dark').replace(/contrast/i, 'Contrast')) as GaugeTheme;
        if (selectedTheme === 'highcontrast') {
            args.gauge.axes[0].annotations[0].content = '<div id="annotation5"><img style="width:15px;height:15px;;margin-left:1px" src="/nextjs/demos/images/circular-gauge/image5.svg" /></div>';
        }
        // custom code end
    }
    ...
    const loadBlueGauge = (args: ILoadedEventArgs): void => {
        ...
        args.gauge.theme = ((selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1)).replace(/-dark/i, 'Dark').replace(/contrast/i, 'Contrast')) as GaugeTheme;
        if (selectedTheme === 'highcontrast') {
            args.gauge.axes[0].annotations[0].content = '<div id="annotation5"><img style="width:17px;height:17px;;margin-top:-2px" src="/nextjs/demos/images/circular-gauge/image6.svg" /></div>';
        }
        // custom code end
    }
                            ...
                            <AxesDirective>
                                <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100} lineStyle={{ width: 0 }} labelStyle={{ font: { size: '0px', color: 'transparent' }, position: 'Inside', useRangeColor: true }} majorTicks={{ height: 0 }} minorTicks={{ height: 0 }}>
                                    <AnnotationsDirective>
                                        <AnnotationDirective content='<div id="annotation1"><img style="width:22px;height:22 px;" src="/nextjs/demos/images/circular-gauge/image1.svg" /></div>' angle={8} radius='80%' zIndex='1' />
                                        <AnnotationDirective content='<div id="annotation2"><img style="width:22px;height:22px;" src="/nextjs/demos/images/circular-gauge/image2.svg" /></div>' angle={11} radius='58%' zIndex='1' />
                                        <AnnotationDirective content='<div id="annotation3"><img style="width:22px;height:22px;" src="/nextjs/demos/images/circular-gauge/image3.svg" /></div>' angle={16} radius='36%' zIndex='1' />
                                    </AnnotationsDirective>
                                    <RangesDirective>
                        ...
                        <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                            <CircularGaugeComponent load={loadRedGauge.bind(this)} id='gaugeTwo' background='transparent' height={"65px"} width={"65px"}>
                                ...
                                <AxesDirective>
                                    <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100} lineStyle={{ width: 0 }} labelStyle={{ font: { size: '0px', color: 'transparent' }, position: 'Inside', useRangeColor: true }} majorTicks={{ height: 0 }} minorTicks={{ height: 0 }}>
                                        <AnnotationsDirective>
                                            <AnnotationDirective content='<div id="annotation1"><img class="firstAnnotation" src="/nextjs/demos/images/circular-gauge/image1.svg" /></div>' angle={0} radius='0%' zIndex='1' />
                                        </AnnotationsDirective>
                                        <RangesDirective>
                        ...
                        <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                            <CircularGaugeComponent load={loadGreenGauge.bind(this)} id='gaugeThree' background='transparent' height={"65px"} width={"65px"} >
                                ...
                                <AxesDirective>
                                    <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100} lineStyle={{ width: 0 }} labelStyle={{ font: { size: '0px', color: 'transparent' }, position: 'Inside', useRangeColor: true }} majorTicks={{ height: 0 }} minorTicks={{ height: 0 }}>
                                        <AnnotationsDirective>
                                            <AnnotationDirective content='<div id="annotation1"><img class="secondAnnotation" src="/nextjs/demos/images/circular-gauge/image2.svg" /></div>' angle={0} radius='0%' zIndex='1' />
                                        </AnnotationsDirective>
                                        <RangesDirective>
                        ...
                        <div className="subgauge" style={{ float: "left", marginTop: "1%" }}>
                            <CircularGaugeComponent load={loadBlueGauge.bind(this)} id='gaugeFour' background='transparent' height={"65px"} width={"65px"} >
                                ...
                                <AxesDirective>
                                    <AxisDirective startAngle={0} endAngle={360} minimum={0} maximum={100} lineStyle={{ width: 0 }} labelStyle={{ font: { size: '0px', color: 'transparent' }, position: 'Inside', useRangeColor: true }} majorTicks={{ height: 0 }} minorTicks={{ height: 0 }}>
                                        <AnnotationsDirective>
                                            <AnnotationDirective content='<div id="annotation1"><img class="thirdAnnotation" src="/nextjs/demos/images/circular-gauge/image3.svg" /></div>' angle={0} radius='0%' zIndex='1' />
                                        </AnnotationsDirective>
                                        <RangesDirective>
