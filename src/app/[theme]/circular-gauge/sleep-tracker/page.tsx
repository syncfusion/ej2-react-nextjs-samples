                ...
                <CircularGaugeComponent load={load.bind(this)} axisLabelRender={axisLabelRender.bind(this)} id='custom-labels' background='transparent'>
                    ...
                    <AxesDirective>
                        <AxisDirective startAngle={0} endAngle={0} radius='70%' minimum={0} maximum={12} majorTicks={{ width: 2, height: 12, interval: 1, offset: 4 }} lineStyle={{ width: 0 }} minorTicks={{ width: 1, height: 7, interval: 0.2, offset: 4 }} labelStyle={{ hiddenLabel: 'First', font: { fontFamily: 'inherit' } }}>
                            <PointersDirective>
                                <PointerDirective type="Marker" value={4.7} markerShape='Image' radius='97%' markerWidth={28} markerHeight={28} imageUrl="/nextjs/demos/images/circular-gauge/sun-icon.png" animation={{ enable: false }} />
                                <PointerDirective type="Marker" value={9} markerShape='Image' radius='98%' markerWidth={28} markerHeight={28} imageUrl="/nextjs/demos/images/circular-gauge/moon-icon.png" animation={{ enable: false }} />
                            </PointersDirective>
                            <RangesDirective>
