                    ...
                    <CircularGaugeComponent load={load.bind(this)} title='Shot Put Distance' background='transparent' loaded={onChartLoad.bind(this)} id='image-container' enablePointerDrag={true} titleStyle={{ fontFamily: 'inherit' }} centerY="57%'">
                        ...
                        <AxesDirective>
                            <AxisDirective startAngle={200} endAngle={130} radius='80%' minimum={0} maximum={14} lineStyle={{ width: 0 }} majorTicks={{ width: 0 }} minorTicks={{ width: 0 }} labelStyle={{ font: { size: '0px' } }}>
                                <PointersDirective>
                                    <PointerDirective type="Marker" value={12} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/foot-ball.png" radius='108%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }} />
                                    <PointerDirective type="Marker" value={11} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/basket-ball.png" radius='78%' markerWidth={28} markerHeight={28} animation={{ duration: 1200 }} />
                                    <PointerDirective type="Marker" value={10} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/golf-ball.png" radius='48%' markerWidth={28} markerHeight={28} animation={{ duration: 900 }} />
                                    <PointerDirective type="Marker" value={12} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/Athletics.png" radius='0%' markerWidth={90} markerHeight={90} animation={{ duration: 0 }} />
                                    <PointerDirective type="Marker" value={0} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/girl.png" radius='108%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }} />
                                    <PointerDirective type="Marker" value={0} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/man-one.png" radius='78%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }} />
                                    <PointerDirective type="Marker" value={0} markerShape="Image" imageUrl="/nextjs/demos/images/circular-gauge/man-two.png" radius='48%' markerWidth={28} markerHeight={28} animation={{ duration: 1500 }} />
                                </PointersDirective>
                                <RangesDirective>
