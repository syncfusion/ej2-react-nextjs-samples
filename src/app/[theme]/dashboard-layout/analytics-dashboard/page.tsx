...
import data from './default-datasource.json';
        ...
        return(
            <div style={{height:"100%", width:"100%"}}>
                <MapsComponent id="maps" load={Mapload.bind(this)} zoomSettings={{ enable: false }} legendSettings={{ visible: false }}>
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={new MapAjax('/nextjs/demos/images/dashboard-layout/world-map.json')} shapePropertyPath='continent' shapeDataPath='continent' dataSource={datasource.default} shapeSettings={{ colorValuePath: 'color' }}>
                                <MarkersDirective>
                                    ...
                                    <MarkerDirective visible={true} shape ='Image' imageUrl= '/nextjs/demos/images/dashboard-layout/ballon.png' height={ 20} width= {20} offset={{ y: -10, x: 0 }} animationDuration={0} tooltipSettings={{ visible: true, valuePath: 'name' }} dataSource={mapData}></MarkerDirective>
                                </MarkersDirective>
                            </LayerDirective>
                        </LayersDirective>
                    </MapsComponent>
