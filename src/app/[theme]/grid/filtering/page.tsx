    ...
    return (
        <div className='control-pane'>
            <div className='col-lg-9 control-section'>
                ...
                <GridComponent dataSource={categoryData} allowSorting={true} allowPaging={true} ref={grid => gridInstance = grid as GridComponent} pageSettings={{ pageSize: 10, pageCount: 5 }} allowFiltering={true}>
                    <ColumnsDirective>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style={{ width: '30%', padding: '10px 10px 10px 0px' }}>
                                    <CheckBoxComponent ref={(scope) => { checkboxObj = scope as CheckBoxComponent; }} change={onChanged.bind(this)}></CheckBoxComponent>
                                </td>
                            </tr>
                        </tbody>
                    </table>
