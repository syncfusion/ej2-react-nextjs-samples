    ...
    return (
        <div className='control-pane'>
            <div className='col-lg-9 control-section'>
                ...
                <GridComponent dataSource={categoryData} allowPaging={true} ref={grid => gridInstance = grid as GridComponent} pageSettings={{ pageSize: 10, pageCount: 5 }} allowFiltering={true}>
                    <ColumnsDirective>
