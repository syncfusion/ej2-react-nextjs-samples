'use client';
import { GridComponent, ColumnsDirective, ColumnDirective, Page, Inject, Resize, Sort, Filter, Edit, Toolbar, EditSettingsModel, ToolbarItems, FilterSettingsModel } from '@syncfusion/ej2-react-grids';
    ...
    return (
        <div className='control-pane'>
            <div className='control-section'>
                <GridComponent dataSource={orderDetails} allowPaging={true} allowResizing={true} allowSorting={true} allowFiltering={true} filterSettings={filterSettings} editSettings={editSettings} toolbar={toolbar}>
                    <ColumnsDirective>
                    ...
                    <Inject services={[Page, Resize, Sort, Filter, Edit, Toolbar]} />
                </GridComponent>
            </div>
