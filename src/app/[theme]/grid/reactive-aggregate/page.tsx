'use client';
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Page, Aggregate, Edit, Sort, Filter, FilterSettingsModel, Toolbar, Group, AggregateColumnsDirective, AggregateColumnDirective, AggregateDirective, AggregatesDirective } from '@syncfusion/ej2-react-grids';
  ...
  return (
    <div className='control-pane'>
      <div className='control-section'>
        <GridComponent dataSource={data} allowPaging={true} allowSorting={true} allowFiltering={true} filterSettings={filterSettings} pageSettings={pageSettings} toolbar={toolbarOptions} editSettings={editSettings} allowGrouping={true} groupSettings={groupSettings}>
          <ColumnsDirective>
          ...
          <Inject services={[Page, Aggregate, Edit, Toolbar, Group, Edit, Sort, Filter]} />
        </GridComponent>
