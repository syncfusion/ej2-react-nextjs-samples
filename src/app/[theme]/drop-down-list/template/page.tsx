...
const Templates = () => {
    ...
    const itemTemplate = (data: any) => {
        return (
            <div><img className="empImage" src={"/nextjs/demos/images/drop-down-list/" + data['Eimg'] + ".png"} alt="employee" />
    ...
    const valueTemplate = (data: any) => {
        return (
            <div className="valueTemplate" ><img className="value" src={"/nextjs/demos/images/drop-down-list/" + data.Eimg + ".png"} height="28px" width="28px" alt="employee" />
