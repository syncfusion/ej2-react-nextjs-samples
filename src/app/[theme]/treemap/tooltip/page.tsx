...
import * as data from './airport-count.json';
                    ...
                    <TreeMapComponent
                        ...
                        tooltipSettings={{
                            ...
                            template:
                                ...
                                '<div id="airplaneicon"><img src = "/nextjs/demos/images/treemap/airplane.svg"; style="background-repeat: no-repeat;float:left;height:32px;width:32px;"/></div>' +
