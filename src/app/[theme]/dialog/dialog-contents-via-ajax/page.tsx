    ...
    return (
      <div className="control-pane">
        <div id="target" className="control-section ajaxcontent col-lg-12">
          ...
          <DialogComponent id="dialog" ref={dialogInstance} visible={status} header={'<img class="img1" src="/nextjs/demos/images/dialog/2.png" alt="Microsoft roadmap">' + 'What’s Coming from Microsoft this Fall'} showCloseIcon={true} animationSettings={animationSettings} width={'500px'} target={'#target'} close={dialogClose} open={dialogOpen} content={innerContent} buttons={buttons}></DialogComponent>
        </div>
