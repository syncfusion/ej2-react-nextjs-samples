...
const Templates = () => {
    ...
    const itemTemplate = useCallback((data: any) => {
        return (
            <div>
                <img className="empImage" src={"/nextjs/demos/images/multi-select/" + data.Eimg + ".png"} alt="employee" />
    ...
    const valueTemplate = useCallback((data: any) => {
        return (
            <div>
                <img className="valueTemp" src={"/nextjs/demos/images/multi-select/" + data.Eimg + ".png"} alt="employee" />
