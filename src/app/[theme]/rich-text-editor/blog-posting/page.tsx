                                            ...
                                            <tr>
                                                <td>
                                                    <span className='e-icon e-like questionSide'>
                                                        <img className='e-icon' src='/nextjs/demos/images/rich-text-editor/like.svg' alt='like'/>
                                                        <span>Like</span>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className='e-icon e-dislike'>
                                                        <img className='e-icon' src='/nextjs/demos/images/rich-text-editor/dislike.svg' alt='dislike'/>
                                                        <span>Dislike</span>
                                                    </span>
                                                </td>
                                            </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <span className='e-icon e-like'>
                                                    <img className='e-icon' src='/nextjs/demos/images/rich-text-editor/like.svg' />
                                                    <span>Like</span>
                                                </span>
                                            </td>
                                            <td>
                                                <span className='e-icon e-dislike'>
                                                    <img className='e-icon' src='/nextjs/demos/images/rich-text-editor/dislike.svg' />
                                                    <span>Dislike</span>
                                                </span>
                                            </td>
                                        </tr>
