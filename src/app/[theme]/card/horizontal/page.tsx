...
import iphone from "@/images/card/iphone.png"
import trimmer from "@/images/card/Trimmer.png"
import Camera from "@/images/card/Camera.png"
                        ...
                        <div className="row card-layout">
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div className="e-card e-card-horizontal e-product" id="horizontal_phone_product">
                                    ...
                                    <Image src={iphone} alt="iPhone X" height={415} style={{ width: '50%' }} />
                                </div>
                            </div>
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div id="vertical_Sample">
                                    <div className="e-card e-card-horizontal" id="horizontal_product">
                                        ...
                                        <Image src={trimmer} alt="Trimmer" />
                                    </div>
                                    <div className="e-card e-card-horizontal" id="horizontal_product">
                                        <Image src={Camera} style={{ height: '214px' }} alt="Camera" />
                                        <div className='e-card-stacked'>
                                            <div className="e-card-header">
                                                <div className="e-card-header-caption">
