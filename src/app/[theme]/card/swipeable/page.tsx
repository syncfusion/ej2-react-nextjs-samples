                        ...
                        <div className="row card-layout">
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6" id="horizontal_product">
                                <div className="e-card e-card-horizontal">
                                    <img src={'/nextjs/demos/images/card/newyork.png'} alt="newyork" />
                                ...
                                <div className="e-card e-card-horizontal">
                                    <img src={'/nextjs/demos/images/card/malaysia.png'} alt="malaysia" />
                                    <div className='e-card-stacked'>
                                ...
                                <div className="e-card e-card-horizontal">
                                    <img src={'/nextjs/demos/images/card/eiffeltower.png'} alt="eiffeltower" />
                                    <div className='e-card-stacked'>
                                ...
                                <div className="e-card e-card-horizontal">
                                    <img src={'/nextjs/demos/images/card/sydney.png'} alt="sydney" />
                                    <div className='e-card-stacked'>
