...
const ProgressBarCustomContents = () => {
    ...
    const content1: string = `<img src="/nextjs/demos/images/progress-bar/material-pause.svg"></img>`;
    const content2: string = `<img src="/nextjs/demos/images/progress-bar/material-Download.svg"></img>`;
    ...
    const progressLoad: EmitType<ILoadedEventArgs> = (args: ILoadedEventArgs) => {
        ...
        if (args.progressBar.element.id === 'label-container') {
            ...
            args.progressBar.annotations[0].content = '<img src="/nextjs/demos/images/progress-bar/' + selectedTheme.replace(/-/i, '') + '-Download.svg"></img>';
        } else {
            args.progressBar.annotations[0].content = '<img src="/nextjs/demos/images/progress-bar/' + selectedTheme.replace(/-/i, '') + '-pause.svg"></img>';
        }
    }
    ...
    const progressCompleted = () => {
        ...
        clearTimeout1 = +setTimeout(
            () => {
                ...
                pausePlay.current.annotations[0].content = '<img src="/nextjs/demos/images/progress-bar/' + (pausePlay.current.theme).toLowerCase() + '-Play.svg"></img>';
    ...
    const progressCompleted2 = () => {
        ...
        clearTimeout2 = +setTimeout(
            () => {
                //tslint:disable-next-line
                downloadProgress.current.annotations[0].content = '<img src="/nextjs/demos/images/progress-bar/' + (downloadProgress.current.theme).toLowerCase() + '-Tick.svg"></img>';
