...
const UiVirtualization = () => {
   ...
   commonData = [
       ...
       { name: 'Margaret', imgUrl: '/nextjs/demos/images/listview/margaret.png', id: '3' },
       { name: 'Steven', icon: 'S', id: '4' },
       { name: 'Laura', imgUrl: '/nextjs/demos/images/listview/laura.png', id: '5' },
       { name: 'Robert', icon: 'R', id: '6' },
       { name: 'Michael', icon: 'M', id: '7' },
       { name: 'Albert', imgUrl: '/nextjs/demos/images/listview/albert.png', id: '8' },
